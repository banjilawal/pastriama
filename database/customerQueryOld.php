<?php
    ...
    use \Shop\Factory\Build;
    use \Shop\Model\Bag\{CreditCardBag, ReviewBag, OrderItems, OrderBag, Cart};
    use \Shop\Model\{Personable, Customer, CreditCard, PostalAddress, Phone, ProteinBar, Order, OrderItem};

    require_once ('../bootstrap.php');
    require_once (MODEL_PATH . DIRECTORY_SEPARATOR . 'phone.php');
    ...
    require_once (MODEL_PATH . DIRECTORY_SEPARATOR . 'personable.php');
    require_once (MODEL_PATH . DIRECTORY_SEPARATOR . 'postalAddress.php');
    ...
    require_once (BAG_PATH . DIRECTORY_SEPARATOR . 'creditCardBag.php');
...
public function get_customer (int $customerId) {
    $result = new OrderBag();
    $mysqli = db_connect();
    ...
    return $result;
        ...
        public function get_orders (int $customerId) {
            $result = new OrderBag();
            $mysqli = db_connect();
            $customerId = $this->get_id();
            echo '<p>getting orders for customer id : ' . $customerID . '</p>';
...
*/ 
        ...
        public static function validate_user ($email, $password) {
            $customer = new \Shop\Database\CustomerQuery ();
            $mysqli = db_connect();
