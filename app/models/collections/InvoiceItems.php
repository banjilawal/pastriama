...
class InvoiceItems extends Model {
     ...
     */
    public function getList (): InventoryItem|array {
        return $this->list;
    }
    ...
    public function add (Pastry $pastry, int $quantity): void {
        ...
        $product = new InventoryItem($pastry, $quantity);
     ...
     */
    public function addProducts (InvoiceItems $products): void {
        foreach ($products as $item) {
            $this->addProduct($item);
        }
    }

    public function addProduct (InventoryItem $product): void {
        $id = $product->getId();
     ...
     * @throws Exception
     */
    public function removeItems (InvoiceItems $items): void {
    ...
    public function increase (Pastry $pastry, int $quantity): void {
        ...
        else { $this->list[$pastry->getId()] = new InventoryItem($pastry, $quantity); }
    }

    /**
     * @throws Exception
     */
    public function transferProductTo (InvoiceItems $destination, Pastry $pastry, int $quantity): void {
        $product = $this->searchByPastry($pastry);
        if (is_null($product)) {
     ...
     * @throws Exception
     */
    public function emptyToTarget (InvoiceItems $target): void {
        foreach ($this->list as $product) {
...
//        }
     ...
     * @throws Exception
     */
    public function getFromSource (InvoiceItems $source, InventoryItem $product): void {
        $id = $product->getId();
    ...
    public function searchByProduct (InventoryItem $product): ?InventoryItem {
        return $this->searchById($product->getId());
    }

    public function contains (InventoryItem $product): bool {
...
//    }
    ...
    public function randomProduct (): InventoryItem {
