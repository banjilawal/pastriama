...
class NewOrders extends Model {
     ...
     * @throws Exception
     */
    public function filterByProduct (Product $product): NewOrders {
        $matches = new NewOrders();
     ...
     * @throws Exception
     */
    public function filterByUser (NewUser $user): NewOrders {
        $matches = new NewOrders();
        foreach ($this->list as $order) {
     ...
     * @throws Exception
     */
    public function filterByDateRange (DateTime $startDate, DateTime $endDate): NewOrders {
        $matches = new NewOrders();
        foreach ($this->list as $order) {
     ...
     * @throws Exception
     */
    public function filterByCreditCard (CreditCard $creditCard): NewOrders {
        $matches = new NewOrders();
        foreach ($this->list as $order) {
