...
class Product extends Entity {
    ...
    public const RESTOCK_THRESHOLD = 12;
    public const MAX_QUANTITY_PER_ORDER = 12;
    public const DEFAULT_RESTOCK_QUANTITY = 144;
...
//    }
    ...
    public function transfer (int $quantity): Product {
        try {
        ...
        return new Product($this->pastry, $quantity);
    }
    ...
    public function toRow (
        ...
        if ($this->quantity <= Product::MAX_QUANTITY_PER_ORDER) {
    ...
    public static function quantitySelector (): string {
        ...
        for ($i = 1; $i <= Product::MAX_QUANTITY_PER_ORDER; $i++) {
