...
$inventoryItem = unserialize($_SESSION['inventory'])->searchById((int) $_COOKIE['inventoryItemId']);
        ...
        <div class="form">
            ...
            >
                <fieldset>
                    ...
                    <div class="formElement"><p> <?php echo InvoiceItem::quantitySelector(); ?> </p></div>
